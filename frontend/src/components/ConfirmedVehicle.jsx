...
const ConfirmedVehicle = (props) => {
    return (
        <div>
            ...
            <h3 className='text-2xl mb-3 text-semibold'>Confirm a Ride</h3>
            <div className='flex gap-2 flex-col justify-center items-center'>
                ...
                className='px-5 py-3 bg-green-500 w-full text-white font-semibold  rounded-xl'>Confirm Ride</button>
            </div>
